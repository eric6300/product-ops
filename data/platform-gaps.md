...
Known differences between platforms, clients, or services. This file is intentionally empty.

<!-- FORMAT SPEC
Use one `## ` block per gap. Append blocks at the end; never edit an existing block.
...
<!-- No entries have been collected yet. -->
